...
// v91 — Apresentação: total só venda sem rack + popup informa exclusões, botões Salvar PDF/Baixar HTML, paleta empresa, logo com fundo do doc, Rede Wi-Fi estável, sem travessões nem nota de rack
